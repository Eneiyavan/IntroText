...
Shortscuts I want to use

Windows logo + Tab (Task view)
Ctrl + Number keys (Switch tabs)
...
## More Resources
More resources that might help  [Useful Resources] (./links.md) page for useful links.
